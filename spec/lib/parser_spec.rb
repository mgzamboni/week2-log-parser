  ...
  describe '#gamelog_json' do
    context 'when valid file' do
      it 'checks if it returns a valid json with correrct info' do
        expect(valid_file.gamelog_json).to eql('{"game_test.log":{"lines":100,"players":["Isgalamido","Dono da Bola","Mocinha"],"kills":{"Isgalamido":3,"Dono da Bola":0,"Mocinha":0},"total_kills":11}}')
      end
    end
